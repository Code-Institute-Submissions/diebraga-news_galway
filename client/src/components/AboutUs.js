    ...
    <>
      <div className="p-4 p-md-5 text-light bg-primary">
        ...
        <div className="col-md-12 px-0 d-flex justify-content-center" >
          ...
          You can peruse all our articles and archives here on our ad-free site. Feel free to follow us on social media (Facebook, Twitter and Instagram) for the best in breaking news, politics and features. If you have a story you think should be featured, you can email us in the GET IN TOUCH section down bellow, or write us a suggestion in our 'Suggest' page.           </p>
        </div>
      </div>
    </>
  )
